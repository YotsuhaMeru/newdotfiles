...
# and in the NixOS manual (accessible by running Åenixos-helpÅf).
...

{
  ...
  # Define a user account. Don't forget to set a password with ÅepasswdÅf.
  users = {
    users.minato = {
      isNormalUser = true;
      description = "Asuka Minato";
      extraGroups = [ "wheel" ]; # Enable ÅesudoÅf for the user.
      shell = pkgs.fish;
  ...
  # on your system were taken. ItÅes perfectly fine and recommended to leave
